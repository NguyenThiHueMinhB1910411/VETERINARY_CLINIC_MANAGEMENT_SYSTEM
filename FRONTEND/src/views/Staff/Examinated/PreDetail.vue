    ...
    <div>
        ...
        <div id="element-to-convert" style="padding: 0 60px;">
            ...
            <div class="row text-center" style="background-color: white; font-size: 16px; padding: 5% 1% 20% 1%;">
                ...
                <!-- <tr v-for="(element, idx) in Prescription.ChiTiet">
                    ...
                    <td rowspan="2">
                        {{ new Intl.NumberFormat('it-IT', { style: 'currency', currency: 'VND' }).format(this.data.ThanhTien).replace("VND", "") }}
                    </td>
                    <td rowspan="2">{{ this.data.GhiChu }}</td>
                </tr> -->
             <tr>
                    ...
                    <td>{{ this.data.ChiTiet[1].slChieu }}</td>
                        ...
                        <!-- <table class="table">
                            ...
                            <tr v-for="(element, idx) in el.ChiTiet">
                                ...
                                <td>{{element.slChieu }}</td>
                                <td>
                                    {{ new Intl.NumberFormat('it-IT', { style: 'currency', currency: 'VND' }).format(element.ThanhTien).replace("VND", "") }}
                                </td>
                ...
                <div class="d-flex justify-content-end">
                    <div class="float-right">
                        <div class="row py-2">
                            <div class="fw-bold text-center">Tổng tiền: {{ new Intl.NumberFormat('it-IT', { style: 'currency', currency: 'VND' }).format(this.data.ThanhTien).replace("VND", "") }} </div>
                            <br>
                        ...
                        <div class="row">
                            ...
                            <div class="fw-bold text-center" v-if="this.data.info1!== undefined">{{ this.data.info1.TenBacSi }}</div>
                        </div>

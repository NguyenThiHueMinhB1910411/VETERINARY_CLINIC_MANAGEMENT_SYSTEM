                                  ...
                                  <tr>
                                    <td>
                                      ...
                                      <input
                                        ...
                                        v-if="this.value.info1 !== undefined"
                                        required
                                    ...
                                    <td>
                                      ...
                                      <input
                                        ...
                                        required
                                        v-if="this.value.info1 !== undefined"
                                        v-model="this.value.info1.Gmail"
                                      />
                                    </td>
                                  </tr>
                                  <tr>
                                    <td>
                                      ...
                                      <input
                                        ...
                                        required
                                        v-if="this.value.info1 !== undefined"
                                        v-model="this.value.info1.TenDichVu"
                                      />
                                    </td>
                                    <td>
                                      Tên vật nuôi:
                                    ...
                                    <td>
                                      ...
                                      <input
                                        ...
                                        id="formGroupExampleInput"
                                        required
                                        v-if="this.value.info2 !== undefined"
                                        v-model="this.value.info2.Gia"
                                      />
                                    </td>
                                    <td>
                                      Ghi chú thêm:
                                      <input
                                        ...
                                        required
                                        v-if="this.value.info2 !== undefined"
                                        v-model="this.value.info2.GhiChuThem"
                                      />
                                    </td>
                                  </tr>
                                </table>

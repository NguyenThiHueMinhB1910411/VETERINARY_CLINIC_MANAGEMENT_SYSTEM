          ...
          <div class="">
            <form class="p-5 border border-dark frame-contact">
              <div class="mb-3 d-flex ">
                <!-- <input  class="form-check-input " type="radio" name="flexRadioDefault" id="flexRadioDefault2"   v-model="this.data.TenLoaiDichVu">
                  Làm đẹp 
              ...
              <div class="d-flex justify-content-center">
                ...
                <button
                  type="button"
                  class="btn text-light button-submit px-4"
    ...
    <div class="py-4 px-5">
      ...
      <div class="row">
        <div class="col-3 px-5 text-center">
          <div>
            <img
              src="../../assets/images/health-icon-1.png"
              alt=""
              class="img-fluid"
            />
          </div>
        ...
        <div class="col-3 px-5 text-center">
          <div>
            <img
              src="../../assets/images/health-icon-2.png"
              alt=""
              class="img-fluid"
            />
          </div>
        ...
        <div class="col-3 px-5 text-center">
          <div>
            <img
              src="../../assets/images/health-icon-3.png"
              alt=""
              class="img-fluid"
            />
          </div>
        ...
        <div class="col-3 px-5 text-center">
          <div>
            <img
              src="../../assets/images/health-icon-4.png"
              alt=""
              class="img-fluid"
            />
          </div>

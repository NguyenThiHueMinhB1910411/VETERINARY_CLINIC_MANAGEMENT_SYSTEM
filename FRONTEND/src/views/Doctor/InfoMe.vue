    ...
    methods: {
        ...
        async retriveMedicalRecord() {
            try {
                ...
                this.listMedicalRecord = this.listMedicalRecord.filter((i) => i.TenLoaiDichVu == "Khám bệnh");
        ...
        filtered(filter) {
            this.filter = this.MedicalRecordService.filter(i => i.TenLoaeDichVu == filter);
        ...
        <div class="col mt-4 mx-2 p-4" style=" box-shadow: 0px 5px 15px rgba(0, 0, 0, 0.25); background-color: white;">
            ...
            <div>
                <div class="row">
                    <div class="py-2">
                        <b>Mã hồ sơ: </b>
                        <span> {{ this.data.MaHoSo}}</span>

                    </div>
                    <div class="py-2 ">
                        <b>Tên vật nuôi: </b>
                        <span v-if="this.data.info2!== undefined">{{ this.data.info2.UsernameVatNuoi }}</span>
                ...
                <div >
                    ...
                    <div class="d-flex justify-content-center mt-3">
                        <button class="btn-service " style="width: 20%;">Khám bệnh</button>
                        <button class="btn-service" style="width: 20%;">Làm đẹp</button>
                        <button class="btn-service" style="width: 20%;">Nội trú</button>
                    </div>
                </div>

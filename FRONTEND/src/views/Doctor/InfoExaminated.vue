        ...
        <div class="col-4">
            <div class="d-flex">
                <div class="" style="font-size: 16px">
                    <button style="background-color: #cc4d26;" class="btn style-button text-light px-2" @click="exportToPDF">
        ...
        <div class="row" style="font-size: 16px;">
            ...
            <div class="col mt-4 mx-2 p-4" style=" box-shadow: 0px 5px 3px  rgba(212, 212, 212, 0.25);  background-color: white;">
                ...
                <div class="py-2" >
                    ...
                    <span > {{ new Intl.NumberFormat('it-IT', { style: 'currency', currency: 'VND' }).format(this.el.ThanhTien).replace("VND", "") }}</span>

      ...
      <table class="table border bg-light ">
        ...
        <tbody>
          <tr v-for="(medical, index) in listMedical" v-bind:key="index">
            ...
            <td>
              <!-- <button @click="deleteMedical(medical,i)" class="bg-danger text-light rounded border-light"> x </button> -->
              <button @click="deleteMedical(i)" class="bg-danger text-light rounded border-light"> x </button>
            </td>
          </tr>
        </tbody>
      </table>
